package net.rinnzenzh.everlastingdusk.world.feature.overworld;
...
public class SpiralFeature extends Feature<NoneFeatureConfiguration> {
    public SpiralFeature() {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> pContext) {
        ...
        Set<Block> validBlocks = Collections.singleton(Blocks.GRASS_BLOCK);
        Block stemMaterial = Blocks.OAK_WOOD;
        Block leafMaterial = Blocks.OAK_LEAVES;

        int blobMass = AllPurposeUtility.randRange(1,1024, random);
        int blobWidth = AllPurposeUtility.randRange(1, 32, random);
        int blobHeight = AllPurposeUtility.randRange(1, 128, random);
